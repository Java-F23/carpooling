...
public class FrameController implements LoginListener, LogoutListener {
    ...
    private void Init() {
        ...
        ((WelcomeComponent) currentFrame).setLoginButtonListener(e -> openLoginFrame());

        // Add action listener for the signup button in WelcomeComponent
        ((WelcomeComponent) currentFrame).setSignupButtonListener(e -> openSignupFrame());
    }
